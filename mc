...
local assets = {
	...
	globe = "rbxassetid://76279363621777",
...
function MacLib:Window(Settings)
	...
	sidebarGroup.Size = UDim2.new(1, 0, 1, 1)
			...
			function TabFunctions:Section(Settings)
				...
				function SectionFunctions:Slider(Settings, Flag)
					...
					local function updateSliderBarSize()
						if not (sliderElementsUIListLayout and sliderValue and sliderName and sliderBar and baseUIScale) then return end
				...
				function SectionFunctions:Input(Settings, Flag)
					...
					inputBox.Size = UDim2.fromOffset(35, 25)
				...
				function SectionFunctions:Dropdown(Settings, Flag)
					...
					dropdownName.Size = UDim2.new(1, -20, 0, 45)
	...
	local buttonPrivate = true
	floatButton.MouseButton1Click:Connect(function()
		buttonPrivate = not buttonPrivate
		WindowFunctions:SetState(buttonPrivate)
	end)
